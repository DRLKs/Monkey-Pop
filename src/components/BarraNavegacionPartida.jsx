...
function BarraNavegacionPartida( {ronda, vidas, monedas, pararReaunudar, acelerarJuego, ralentizarJuego,  reiniciarJuego, abrirAjustes, agarrarMono, cronometroActivo, funcionVolver} ){
